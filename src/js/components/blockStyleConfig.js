...
function sortableOptions(extra = {}) {
  return {
    ...
    filter:          ['.palette-item-info', '.palette-item-place-btn', '.block-card-action-btn', '.block-card-expand-btn', '.subblock-panel', '.inline-timer', extra.filter].filter(Boolean).join(', '),
